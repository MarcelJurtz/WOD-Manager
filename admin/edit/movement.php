...
$stmt = $con->prepare('SELECT id, designation, displayname, hashtags FROM movement WHERE id = ?');
$stmt->bind_param('i', $_GET["move"]);
$stmt->execute();
...
<body class="loggedin">
    ...
    <div class="container card mt-3">
        <form action="./../save/movement.php" method="post">
            <input type="hidden" name="id" value="<?= $id ?>">

            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-between border-bottom py-3  mb-3">
                        <h2><?= isset($displayname) ? $displayname : "New Movement" ?></h2>
                        <div>
